 ...
 * Edited by mprough PRO-Webs.net for ship lead time by manufacturer 4-1-2015  
 */
...
//bof edited for ship lead 1 of 3
            $ship_lead = zen_db_prepare_input($_POST['ship_lead']);

            $insert_sql_data = array('ship_lead' => $ship_lead);
            $sql_data_array = array_merge($sql_data_array, $insert_sql_data);
...
//eof edited for ship lead 1 of 3
...
//bof edited for ship lead 2 of 3
                                    $contents[] = array('text' => '<br />' . TEXT_MANUFACTURERS_LEAD . '<br>' . zen_draw_input_field('ship_lead', '', zen_set_field_length(TABLE_MANUFACTURERS_INFO, 'ship_lead')));
//eof edited for ship lead 2 of 3
...
//bof edited for ship lead 3 of 3 
                                    $mfg_ship_lead = $db->Execute("SELECT ship_lead FROM " . TABLE_MANUFACTURERS_INFO . " WHERE manufacturers_id='" . zen_db_prepare_input($_GET['mID']) . "'");
                                    $contents[] = array('text' => '<br />' . TEXT_MANUFACTURERS_LEAD . '<br>' . zen_draw_input_field('ship_lead', $mfg_ship_lead->fields['ship_lead'], zen_set_field_length(TABLE_MANUFACTURERS_INFO, 'ship_lead')));
//eof edited for ship lead 3 of 3
